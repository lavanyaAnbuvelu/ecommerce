                ...
                <div className='max-w-360 w-full  mx-auto'>
                    <div className='lg:flex gap-5 xl:gap-10 justify-between w-full space-y-10 '>
                        ...
                        <div className='space-y-2 w-full lg:w-1/3 mx-auto'>
                            ...
                            <p className='text-[#290a03] lg:text-3xl text-2xl hover:underline underline-offset-2 no-underline  font-bold bellota-text'>+0123-456-9870</p>
                        ...
                        <div className='flex lg:justify-around lg:gap-0 gap-8 justify-start sm:10 mx-auto w-full lg:w-1/3 text-nowrap'>
                            <div>
                                ...
                                <div className='list-none font-semibold text-gray-500  space-y-0'>
                                 <Link to={'/'}> <li className='hover:underline underline-offset-2 no-underline'>Home</li></Link>
                                   <Link to={'/about'}> <li className='hover:underline underline-offset-2 no-underline'>About</li></Link>
                                    <Link to={'/contact'}><li className='hover:underline underline-offset-2 no-underline'>Contact</li></Link>
                                    <Link to={'/blog'}><li className='hover:underline underline-offset-2 no-underline'>Blog</li></Link>
                                    <Link to={'#'}><li className='hover:underline underline-offset-2 no-underline'>Search results</li></Link>
                                </div>
                            </div>
                            <div>
                                <h1 className='text-xl text-[#290a03] font-medium mb-4 bellota-text'>Our utilities</h1>
                                <div className='list-none font-semibold text-gray-500 space-y-0'>
                                    <li className='hover:underline underline-offset-2 no-underline'>Style guide</li>
                                    <li className='hover:underline underline-offset-2 no-underline'>Changelog</li>
                                    <li className='hover:underline underline-offset-2 no-underline'>Licenses</li>
                                    <li className='hover:underline underline-offset-2 no-underline'>protected pages</li>
                                    <li className='hover:underline underline-offset-2 no-underline'>404</li>
                                </div>
                            </div>
                        </div>
                    </div>
