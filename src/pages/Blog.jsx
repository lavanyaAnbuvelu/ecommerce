    ...
    return (
        <>
            <div className='max-w-360 mx-auto'>
                <div className=' pt-25 lg:pt-45 space-y-4 gap-8 px-4 '>
                    ...
                    <div className='space-y-4 '>
                        ...
                        <div className='sm:flex gap-4 space-y-2 lg:space-y-0'>
                            <p className='sm:text-lg text-sm  text-gray-500'>Follow us</p>
                            <p className='sm:text-lg text-center text-sm text-[#290a03] flex gap-4 font-semibold'><FaFacebook size={25} /> <BsInstagram size={25} /> <FaTwitter size={25} /> <FaYoutube size={30} /></p></div>
                    </div>
                </div>
                <img src="/images/imgi_11_6904b3e08033dac4148421bb_blog-main-2.png" alt="" className='rounded-4xl lg:pt-10 pt-5 px-4' />
            </div>
            <div className='max-w-210 mx-auto px-4 space-y-6 pt-5 lg:pt-15'>
                ...
                <div className='md:text-lg text-sm  font-medium text-[#290a03] space-y-2'>
                    <p className='flex gap-2 items-center'><GoDotFill/> Heated air moves in a cycle within the oven, carrying heat to the food.</p>
                    <p className='flex gap-2 items-center'><GoDotFill/> Bread and other flour-based items are the most common baked goods.</p>
                    <p className='flex gap-2 items-center'><GoDotFill/> Making cuts on the surface of dough before baking to control expansion.</p></div>
                <div>
