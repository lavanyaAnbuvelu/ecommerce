                ...
                <div className='lg:flex gap-6'>
                    ...
                    <div className='bg-[#f4ebe2] rounded-3xl p-8 mt-8 lg:mt-0 my-5'>
                        ...
                        <form onSubmit={() => sendToWhatsapp(data)}className=''>
                            ...
                            <button type='submit' className='bg-amber-400 text-[#290a03] hover:bg-[#290a03] hover:text-amber-400 hover:cursor-pointer w-50 p-3 rounded-full flex gap-4 items-center'>
                                <GoDotFill />
                                <p>Send a message</p>
                            </button>
                        </form>
