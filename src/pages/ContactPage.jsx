    ...
    return (
        <>
            ...
            <div className='max-w-360 lg:mx-auto px-4'>
                <div className='grid lg:grid-cols-7 grid-cols-2 gap-4 pt-5 md:pt-20 '>
                    <div className=' group bg-[url(/images/imgi_21_68d51c5fa2dde26b3dad27a3_instagram-5.png)] bg-cover rounded-3xl order-1 p-2'>
                    ...
                    <div className=' group bg-[url(/images/imgi_20_68d51c5f58db4a526ef96a69_instagram-4.png)] bg-cover rounded-3xl order-2 p-2'>
                        <div  className= ' bg-[#290a03] lg:h-55 w-full h-full  p-4 lg:pt-15 lg:px-10 space-y-4 opacity-0 hover:cursor-pointer group-hover:opacity-50 rounded-3xl'>
                            <div className='flex flex-col text-center items-center gap-2' >
                            <img src="/images/imgi_17_68c951a602ea9a2f03977839_instagram-feed.png" className=' ' alt="" />
                            <h1 className='text-xl text-amber-400 '>@Bisqueria</h1></div>
                    ...
                    <div className=' group bg-[url(/images/imgi_19_68d51c5ff25a8769cb090e6e_instagram-3.png)] bg-cover order-3 rounded-3xl p-2'>
                    ...
                    <div className=' bg-[#290a03] h-60  rounded-3xl pt-15 space-y-3 col-span-2 lg:col-span-1 lg:order-4 order-7  '>
                        <div className='flex flex-col space-y-2 text-center items-center'>
                        <img src="/images/imgi_17_68c951a602ea9a2f03977839_instagram-feed.png" className='h-8 w-8' alt="" />
                        <p className='text-xl text-white font-semibold text-wrap '>Freshly baked daily</p>
                            <h1 className='text-xl text-amber-400 '>@Bisqueria</h1></div>
                    </div>


                    <div className=' group bg-[url(/images/imgi_16_68d51c60e940f3ff64e0808c_instagram-1.png)] order-5 bg-cover rounded-3xl p-2'>
                        <div  className= ' bg-[#290a03] lg:h-55 w-full h-full  p-4 lg:pt-15 lg:px-10 space-y-4 opacity-0 hover:cursor-pointer  group-hover:opacity-50 rounded-3xl'>
                            <div className='flex flex-col text-center items-center gap-2' >
                            <img src="/images/imgi_17_68c951a602ea9a2f03977839_instagram-feed.png" className='' alt="" />
                            <h1 className='text-xl text-amber-400 '>@Bisqueria</h1></div>
                    ...
                    <div className=' group bg-[url(/images/imgi_22_68d51c5f3a9cd1643e8bcb43_instagram-6.png)] bg-cover order-6 rounded-3xl p-2'>
                        <div  className= ' bg-[#290a03]  lg:h-55 w-full h-full p-4 lg:pt-15 lg:px-10 space-y-4 opacity-0 hover:cursor-pointer group-hover:opacity-50 rounded-3xl'>
                            <div className='flex flex-col text-center items-center gap-2' >
                            <img src="/images/imgi_17_68c951a602ea9a2f03977839_instagram-feed.png" className='' alt="" />
                            <h1 className='text-xl text-amber-400 '>@Bisqueria</h1></div>
                    ...
                    <div className=' group bg-[url(/images/imgi_21_68d680689c9187b6a5e053c9_products-10.png)] bg-cover rounded-3xl lg:order-7 order-4 p-2'>
                        <div  className= ' bg-[#290a03]  lg:h-55 w-full h-full  p-4 lg:pt-15 lg:px-10  space-y-4 opacity-0 hover:cursor-pointer group-hover:opacity-50 rounded-3xl'>
                            <div className='flex flex-col text-center items-center gap-2' >
                            <img src="/images/imgi_17_68c951a602ea9a2f03977839_instagram-feed.png" className='' alt="" />
                            <h1 className='text-xl text-amber-400 '>@Bisqueria</h1></div>
